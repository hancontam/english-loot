        ...
        <section className="flex min-w-0 flex-1 flex-col bg-loot-card">
          <header className="flex h-16 shrink-0 items-center gap-3 border-b border-loot-border px-6 lg:px-8">
            <button
              ...
              className="grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-transparent text-loot-muted transition-colors hover:bg-loot-selected hover:text-loot-text"
